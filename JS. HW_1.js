...
console.log("item_1 == " + item_1); // 3. Вывести в консоль item_1.

let item_2; // 4. Создать переменную “item_2”

item_2 = 3; // 5. Присвоить переменной item_2 цифру 3.
console.log("item_1 == " + item_2); // 6. Вывести в консоль item_2.

let item_3; // 7. Создать переменную “item_3”

item_3 = item_1 + item_2; // 8. Присвоить переменной item_3 сложение item_1 и item_2.
console.log("item_3 == " + item_3); // 9. Вывести в консоль item_3.

let item_4 // 10. Создать переменную “item_4”

item_4 = "Yolochka"; // 11. Присвоить переменной item_4 строку “Yolochka”
console.log("item_4 == " + item_4);  // 12. Вывести в консоль item_4.
console.log("item_3 + item_4 == " + (item_3 + item_4)) // 13. Вывести в консоль сложение item_3 и item_4.
console.log("item_3 * item_4 == " + (item_3 * item_4)) //  14. Вывести в консоль умножение item_3 и item_4.
...
console.log("item_6_type == " + typeof(item_6_type)) // 21. Вывести в консоль тип данных item_6 в виде ——  “item_6 == ”  item_6,  “item_6_type == ”  item_6_type ——
...
console.log("item_7_type == " + typeof(item_7_type)) // 25. Вывести в консоль тип данных item_7 в виде ——  “item_7 == ”  item_7,  “item_7_type == ”  item_7_type ——
